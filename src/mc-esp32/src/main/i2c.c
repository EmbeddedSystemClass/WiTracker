...
void mc_i2c_init()
{
    ...
    conf.sda_io_num = I2C__MASTER_SDA_IO;
...
//     {
//         printf("test cnt: %d\n", cnt++);
//         ret = i2c_example_master_sensor_test(I2C_MASTER_NUM, &sensor_data_h, &sensor_data_l);
...
//             ret = i2c_example_master_read_slave(I2C_MASTER_NUM, data_rd, DATA_LENGTH);
//         }
//         else
//         {
//             ret = i2c_example_master_read_slave(I2C_MASTER_NUM, data_rd, RW_TEST_LENGTH);
//         }
...
//         ret = i2c_example_master_write_slave(I2C_MASTER_NUM, data_wr, RW_TEST_LENGTH);
//         if (ret == ESP_OK)
//         {
